...
class VitalMonitor:
    ...
    def check_Heartbeat(self):
        if 145 < float(self.Heartbeat):  # acceptable heartrate for an active adult is from 114-145
        ...
        elif float(self.Heartbeat) <= 145 and int(self.Heartbeat) >= 120:
    ...
    def check_Temp(self):
        if 102 > float(self.Temp) and float(self.Temp) >= 99:  # acceptable body temperature is from 97-99 degrees fahrenheit in the regular adult.
